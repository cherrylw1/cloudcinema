...
export class SupabaseMediaRepository implements MediaRepository {
  ...
  async getMediaById(id: string): Promise<Media | null> {
    ...
    return {
      ...
      tmdbVoteAverage: data.tmdb_vote_average,
      tmdbVoteCount: data.tmdb_vote_count,
      tmdbGenreIds: Array.isArray(data.tmdb_genre_ids) ? data.tmdb_genre_ids as number[] : null,
      tmdbOriginalLanguage: data.tmdb_original_language,
